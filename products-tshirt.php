...
<body>
  ...
  <main>
    <h1 class="text-center">Tshirt</h1>
    ...
    <div class="container mt-6">
      <div class="row">
        ...
        $stmt = $db->query("SELECT ProductID, ProductName, Price, ImageUrl FROM inventory WHERE CategoryID = 1 $brandCondition $priceCondition $orderBy");
