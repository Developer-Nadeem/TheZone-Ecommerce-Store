    ...
    <div class="col-md-6 offset-md-3">
      <form method="get" class="d-flex align-items-center justify-content-end">
        ...
        <select name="brand" class="form-select ms-2">
          ...
          <option value="brand1">method tech</option>
          <option value="brand2">vans</option>
          <option value="brand1">malita</option>
...
<!-- Filter and Sort Box End -->
  ...
  <main>
    ...
    <p class="text-center">Explore The Zone's exclusive t-shirt collection, where streetwear fashion meets comfort, offering the latest styles to elevate your urban lifestyle.</p>
    <div class="container mt-6">
      <div class="row">
        ...
        // gets all products under the T-Shirt category
        $stmt = $db->query("SELECT ProductID, ProductName, Price, ImageUrl FROM inventory WHERE CategoryID = 1");
