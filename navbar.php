<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img class="img-fluid logo" src="images/logo-tp.png"
                    alt="Logo"></a>
            ...
            ?>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-dark shopping-cart-button" href="shopping-cart.php"><img
                                src="images/shopping-cart-icon-nonhover.png" alt="Shopping Cart" width="20"
                                height="20"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="user-page.php"><i class="fas fa-user"></i></a>
                    </li>
                </ul>
