  ...
  <main>
    ...
    <section>
      ...
      <div class="container-fluid hero">
        ...
        <img class="img-fluid hero-img" src="images/fashionable-men-jacket-hanging-clothing-store-generated-by-ai.jpg" alt="heropage">
    ...
    <section>
      ...
      <div class="container-fluid aboutsection">
        <img class="img-fluid" src="images/cool-man-with-hoodie.jpg" alt="heropage">
        <div style="color: white;">
          ...
          <a style="position: absolute; top: 210%; left: 42%;" href="../TheZone/products-men.php" class="big-button" id="hero-btn">Discover Your True Style</a>
        </div>
      </div>
